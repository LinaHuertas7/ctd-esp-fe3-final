...
import { getCharacter, getComicsAsociate } from 'dh-marvel/services/marvel/marvel.service'
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={`Detalle del personaje ${personaje.name}`} />
      ...
      <BodySingle title={'Detalle del Personaje'}>
        <Grid container spacing={6} mb={6}>
          ...
          <Grid item xs={12} md={6}>
            <Typography gutterBottom variant="h5" mb={3} fontWeight='bold' component="div">
