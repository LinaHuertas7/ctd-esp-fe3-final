	...
	return (
		<>
			<Head>
				...
				<meta
					name="description"
					content={`Aquí encontrarás el detalle del comic ${comic.title}`}
				/>
			...
			<BodySingle title={`Detalle del comic`}>
				...
				>
					...
					>
						...
						>
							{comic?.stock !== 0
								? `Stock disponible: ${comic?.stock} unidades`
								: "Sin stock"}
						</Typography>
						<Typography
							variant="subtitle2"
						...
						>
							...
							<AccordionDetails
								sx={{ fontStyle: "italic", mt: "6px", color: "GrayText" }}
							>
								{comic.description
									? comic.description
									: "No hay una descripción del comic selecionado"}
							</AccordionDetails>
						</Accordion>
									...
									<ul>
										{comic.characters.items.map((character, index) => (
											<li
												...
												onClick={() =>
													handleClickUrlCharacter(character.resourceURI)
												}
											>
												{character.name}
											</li>
